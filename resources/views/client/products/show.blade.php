    ...
    <div class="prod-detail-bg py-4" id="productDetailContainer" data-is-guest="{{ auth()->guest() ? 'true' : 'false' }}"
        ...
        <div class="container">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="prod-media-box">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-3 pt-3 border-top">
                                ...
                                {{-- Nút Đã Thích (Like) --}}
                                <button type="button"
                                    class="btn btn-like-product {{ session('liked_product_' . $product->id) ? 'liked' : '' }}"
                                    id="btnLikeProduct" onclick="toggleProductLike({{ $product->id }})">
                                    <i class="fa-solid fa-heart me-1"></i>
                                    <span>Đã thích (<strong
                                            id="likesCountNum">{{ number_format($likesCount) }}</strong>)</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-6 d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap mb-3 text-muted small">
                            <div class="d-flex align-items-center">
                                <span
                                    class="text-danger fw-bold me-1 text-decoration-underline fs-6">{{ $avgRating }}</span>
                        ...
                        <div class="prod-policy-box mb-3 small text-secondary">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <strong class="text-dark">Miễn phí vận chuyển:</strong> Giao hàng miễn phí cho đơn hàng
                                    từ 200.000₫
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <strong class="text-dark">An tâm mua sắm:</strong> Trả hàng miễn phí 15 ngày • Chính
                        ...
                        <div class="d-flex align-items-center gap-3 mb-4">
                            ...
                            <div class="input-group input-group-sm qty-input-wrap" style="width: 130px;">
                                ...
                                <input type="number" id="buyQuantity" class="form-control text-center fw-bold"
                                    value="1" min="1" max="{{ $product->stock }}">
                                <button class="btn btn-outline-secondary" type="button"
                                    onclick="adjustQty(1)">+</button>
                            </div>
                            <span class="text-muted small">Còn lại <strong
                                    id="stockDisplay">{{ $product->stock }}</strong> sản phẩm</span>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-5 border-end-md">
                        <div class="d-flex align-items-center gap-3">
                            <div class="shop-avatar-wrap position-relative">
                                @if ($avatarUrl)
                                    <img src="{{ $avatarUrl }}" alt="{{ $shopName }}"
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="row text-center g-3 shop-stats-grid">
                            ...
                            <div class="col-4 col-md-2">
                                ...
                                <strong
                                    class="text-danger">{{ number_format($profile?->products()->where('status', 'approved')->count() ?? 0) }}</strong>
                            </div>
                            <div class="col-4 col-md-2">
                            ...
                            <div class="col-4 col-md-3">
                                ...
                                <strong
                                    class="text-danger">{{ number_format($profile?->followers()->count() ?? 0) }}</strong>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('categories.index') }}"
                                            class="text-danger text-decoration-none">Cupo</a> &gt;
                                        @if ($product->category)
            ...
            <div class="card border-0 shadow-sm rounded-3 mb-4 p-3 p-lg-4" style="background:#fff;" id="reviews-section">
                ...
                {{-- Rating Summary Bar --}}
                <div class="row align-items-center p-3 mb-4 rounded-3"
                    style="background: #fffbf8; border: 1px solid #fbe3d5;">
                    ...
                    @forelse ($product->reviews as $rev)
                        <div class="review-item border-bottom pb-3 mb-3">
                            <div class="d-flex gap-3">
                                ...
                                <div class="flex-fill">
                                    <div class="fw-bold text-dark mb-1">{{ $rev->user->name ?? 'Khách hàng ẩn danh' }}
                                    </div>
                                    ...
                                    <div class="text-muted extra-small mb-2">
                                        {{ $rev->created_at ? $rev->created_at->format('d/m/Y H:i') : 'Mới đây' }}</div>
